...
/*
	...
	+: возможность встроенной проверки уникальности, самый быстрый вариант
	-: создание доп таблицы, сложность обработки информации
*/
...
/*
	...
	+: Отсутствие доп.таблицы, при небольшом объеме данных очень удобно.
	-: Отсутствует встроенная проверка уникальности, нужна доп. реализация. При больших объемах, медленней чем 1-й вариант
*/
